...
public class Pi_system extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  public Pi_system( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public Pi_system( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
...
protected class sis032260_transmitter extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 7, 7, -234, -234}, new int[] { 12, 10, 156534,-170}, 4),
  };
  public void paintComponent(Graphics g1) {
    animationCount = 1;
    if ( !visible)
