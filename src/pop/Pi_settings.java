...
public class Pi_settings extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  public Pi_settings( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public Pi_settings( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
